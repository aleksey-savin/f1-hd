...
// создании сеанса и сам отзывает сеансы. У `isActive` из этого не было ничего —
// отключённый пользователь жил до истечения собственного токена. Срок
// `banExpires` при этом считает и снимает наш `services/authBan`: до хука
// плагина наши гейты не доходят.
//
