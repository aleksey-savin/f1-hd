 ...
 * должно. Поля `members` и `matches` здесь не читаются: это данные раздачи
 * конкретной установки, а у новой людей ещё нет. Администратору назначается
 * роль полного доступа: `isAdmin` остаётся
