  ...
  },
  {
    ...
    actions: [
      ...
      { id: "user.manage", label: "Заводить и изменять людей" },
      {
        ...
        hint: "Пароли, сеансы, второй фактор и раздача ролей. Отдельно от «изменять людей»: вести карточку и распоряжаться входом — разные уровни доверия.",
      },
      {
        id: "user.impersonate",
    ...
    actions: [
      {
        id: "role.read",
        label: "Видеть роли",
        hint: "Нужно и тому, кто ролей не правит: в форме человека роль выбирают из списка.",
      },
