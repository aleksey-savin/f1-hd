  ...
  if (!open) {
    return (
      <button
        ...
        className="flex w-full cursor-pointer appearance-none items-center gap-2.5 rounded-xl border border-border bg-card px-4 py-2.5 text-left outline-none focus-visible:ring-4 focus-visible:ring-ring/50"
      >
        <span
