    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          ...
          "flex h-10 w-full appearance-none rounded-md border-0 bg-transparent py-3 text-sm outline-hidden placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50",
          className,
        )}
        {...props}
      />
