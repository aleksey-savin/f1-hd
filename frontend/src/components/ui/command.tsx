  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          // appearance-none/border-0: preflight выключен — иначе голый <input>
          // рисует браузерную рамку («коробка в коробке»), см. ux-ui-guide
          "tw:flex tw:h-10 tw:w-full tw:appearance-none tw:rounded-md tw:border-0 tw:bg-transparent tw:py-3 tw:text-sm tw:outline-hidden tw:placeholder:text-muted-foreground tw:disabled:cursor-not-allowed tw:disabled:opacity-50",
          className
        )}
        {...props}
      />
