...
// Каналы личных уведомлений — порядок колонок матрицы «событие × канал» в
// «Моём аккаунте», форме и карточке. Ключ — поле в user.notify; «в
// приложении» первым: он работает всегда, без бота и почты
export const NOTIFY_CHANNELS = [
  { key: "inApp", label: "Приложение" },
  { key: "byTelegram", label: "Telegram" },
  { key: "byEmail", label: "E-mail" },
];
