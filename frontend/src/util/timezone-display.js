...
/**
 * Часовой пояс организации — единственный пояс РАСЧЁТА: в нём заданы графики,
 * в нём сервер считает периоды отчётов. Показ может идти в личном поясе
 * человека (util/format-date), поэтому там, где расхождение возможно, экран
 * подписывает пояс явно.
 */
